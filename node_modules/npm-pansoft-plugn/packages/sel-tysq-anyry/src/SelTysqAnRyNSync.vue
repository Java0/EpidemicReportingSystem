...
export default {
    ...
    methods: {
        ...
        choseAll(){
            this.rightRyData=mergeArray(deepClone(this.rightRyData),deepClone(this.leftRyData),"yhid");
        },
        clearAll(){
            this.rightRyData=[];
        },
