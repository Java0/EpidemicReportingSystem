...
var common = {
    ...
    state: {
        language: (0, _store.getStore)({ name: 'language' }) || 'zh',
        isCollapse: false,
        isFullScren: false,
        isShade: false,
        screen: -1,
        isLock: (0, _store.getStore)({ name: 'isLock' }) || false,
        showTag: true,
        showDebug: true,
        showCollapse: true,
        showSearch: true,
        ...
        showMenu: true,
        showColor: true,
        colorName: (0, _store.getStore)({ name: 'colorName' }) || '#409EFF',
        themeName: (0, _store.getStore)({ name: 'themeName' }) || 'theme-white',
        lockPasswd: (0, _store.getStore)({ name: 'lockPasswd' }) || '',
    ...
    mutations: {
        ...
        SET_DIALOG_SHOW: function SET_DIALOG_SHOW(state, showDialog) {
